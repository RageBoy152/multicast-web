    ...
    <section className="flex flex-col items-center w-full h-[calc(100vh-50px)] overflow-auto">
      <div className="w-10/12 py-4">
        <div className="text-xxl flex items-center justify-between">
          <h1>Outputs</h1>
          <p className="text-xs">
            MultiCast V2.0 | Developed by <a href="https://discord.com/users/693191740961718420" target='_blank' className="text-text-shade hover:text-text underline">Rage</a>
          </p>
        </div>
